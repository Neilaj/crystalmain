        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3 flex gap-3">
              ...
              <a href="mailto:info@crystalstudios.net" className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-800 text-gray-400 hover:bg-red-700 hover:text-white transition-colors">
